...
def geodesic_distance_batch(
    ...
    *,
    ...
    distances = _geodist_rs.geodesic_distance_batch(
...
def geodesic_with_bearings_batch(
    ...
    *,
    ...
    model = _coerce_ellipsoid(ellipsoid)
    distances, initial_bearings, final_bearings = _geodist_rs.geodesic_with_bearings_batch(
        origin_batch.lat_deg,
        origin_batch.lon_deg,
        destination_batch.lat_deg,
        destination_batch.lon_deg,
...
def geodesic_distance_to_many(
    ...
    *,
    ...
    distances = _geodist_rs.geodesic_distance_to_many(
        lat,
        lon,
        destination_batch.lat_deg,
        destination_batch.lon_deg,
...
def area_batch(
    ...
    *,
    ...
    model = _coerce_ellipsoid(ellipsoid)
    areas = _geodist_rs.polygon_area_batch(
        polygons.coords,
