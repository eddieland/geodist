...
def hausdorff_directed_clipped(a: list[Point], b: list[Point], bounding_box: BoundingBox) -> HausdorffDirectedWitness: ...
...
def hausdorff_directed_clipped_3d(a: list[Point3D], b: list[Point3D], bounding_box: BoundingBox) -> HausdorffDirectedWitness: ...
